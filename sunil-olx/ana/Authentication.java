	...
	void updateEmail() {
		...
		try {
			...
			String emailId2;
		     ...
		     Connection con = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521/orc", "amazon", "amazon");
		     ...
		     while(rs.next()) {
		    	 ...
		    	 if(z.equals(emailId))
		    	 {
		    		 ...
		    		 if(emailId2.equals(emailId3)) {
		    			 String sql="Update users set email='" + emailId2 + "' where email='" + emailId + "'";					     System.out.println(1);
