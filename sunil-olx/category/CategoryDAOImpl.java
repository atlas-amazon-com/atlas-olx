...
import category.CategoryConstants.CategoryColumnNames;
import classifieds.ClassifiedDAOImpl;
...
//delete from classifieds where category_id in (select id from category where primary_category = 'xyz');
//
//delete from category where primary_category = 'xyz';
